...
- Fixed Wayland input device discovery to drain queued libei events and wait for all granted devices to resume ([#13210](https://github.com/can1357/oh-my-pi/pull/13210) by [@Komzpa](https://github.com/Komzpa)).
